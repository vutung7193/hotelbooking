...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 20 Mai 2015 à 05:53
...
INSERT INTO `tbl_hotels` (`id`, `name`, `City`, `address`, `description`, `rank`, `aver_point`) VALUES
(2, 'Muong Thanh Hotel', 'Ha Noi', 'Nam Tu Liem', 'dsfsd', 3, 4.6666666666667),
(3, 'Trang Tien Ha Noi Hotel', 'Ha Noi', '130 Trang Tien Hoan Kiem Ha Noi', 'dsvdfbfgnmm\r\nghmhjmj\r\njh,hj,\r\n', 5, 2),
(4, 'Ha Thanh Plaza', 'Ha Noi', 'nam t? liêm hà n?i', ' skvd fkv', 4, 9),
(5, 'Royal Hotel Ha Noi', 'Ha Noi', '130 Trang Tien Hoan Kiem Ha Noi', 'sc  ,mv', 5, NULL),
(7, 'Mariot Ha Noi', 'Ha Noi', 'nam t? liêm hà n?i', 'dfgdfgd', 5, 5.75),
(8, 'Kaeng Nam Ha Noi', 'Hà N?i', 'nam t? liêm hà n?i', 'ksdvksdnv', 5, NULL),
(9, 'KeangNam', 'Ha Noi', '371 Khuong Trung Ha Noi', 'jd vf fv jf v fjkvf jv', 5, 8),
(10, 'Phu Quy Hotel', 'Ha Noi', '130 Trang Tien Hoan Kiem Ha Noi', 'dsvdv', 4, NULL),
(11, 'Tan Thanh Hotel', 'Ha Noi', '130 Trang Tien Hoan Kiem Ha Noi', 'c smc', 3, NULL);
...
INSERT INTO `tbl_rooms` (`id`, `name`, `hotel_id`, `purpose_id`, `roomtype_id`, `price`, `description`) VALUES
(1, 'Meeting-Vip', 2, 3, 13, 1600000, ''),
(2, 'Meeting-Deluxe', 2, 3, 14, 2000000, ''),
(3, 'test', 2, 3, 13, 1230000, ''),
(4, 'Meeting-Casual', 2, 3, 13, 12, ''),
(5, '101', 2, 3, 13, 19, '');
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'webmaster@example.com', '9a24eff8c15a6a141ece27eb6947da0f', 1261146094, 1432026682, 1, 1),
...
ALTER TABLE `tbl_image`
  ...
  ADD CONSTRAINT `tbl_image_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `tbl_rooms3` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
