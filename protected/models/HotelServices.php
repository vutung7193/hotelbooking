...
class HotelServices extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('hotel_id, service_id, price', 'required'),
			array('hotel_id, service_id', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, hotel_id, service_id, price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bookingDetails' => array(self::HAS_MANY, 'BookingDetail', 'service_id'),
