                        ...
                        <tr>
                            <td align="right">
                                <form action="http://google.com.vn" method="get">
                                    <input type="text" name="q" id="s" placeholder="Search Google"
                    ...
                    <table style="width: 100px">
                        ...
                        <tr>
                                       <td>
                                           ...
                                           ?>
                                    <form action="<?php if(Yii::app()->user->isGuest) echo $this->createUrl('/user/login');
else { echo $this->createUrl('/user/logout');}?>" method="post">
                                        <input type="submit" name="" value="<?php echo $name;?>">
                                    </form>
            </td>
                            <td>
                                    <form  action="<?php echo $this->createUrl('/user/registration')?>" method="post">
                                        <input type="submit" name="" value="Register Here">
                                    </form>
...
<div id="menu-bg">
    <div id="menu">
        <ul>
            <li id="sale"><a href="<?php echo $this->createUrl('/')?>" title="Trang chủ">Homepage</a></li>
             <li ><a href="<?php echo $this->createUrl('/')?>" title="">Hotels</a></li>
              <li><a href="<?php echo $this->createUrl('/')?>" title="">Contact</a></li>
              <li><a href="<?php echo $this->createUrl('/')?>" title="">About Us</a></li>
               <li><a href="<?php echo $this->createUrl('/')?>" title="">Help</a></li>

                             

                 <li ><a href="http://localhost/hotel6/admin.php?r=user/login" title="Quản Trị">admin</a></li>
        </ul>
    </div>
</div>
<!--menu-->
